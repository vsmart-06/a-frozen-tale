...
class HelpView(discord.ui.View):
    def __init__(self, user: discord.User = None):
        ...
        self.helps[1] = discord.Embed(title = "Part 1: The Song", description = "At the beginning of the movie Frozen, Anna asked Elsa to play with her through the iconic **Do you want to build a snowman?** song. Let's try to fulfill Anna's dream ourselves, even though she could not!", colour = discord.Colour.blue())
